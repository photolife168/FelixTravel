...
public class TravelFoodFragment extends Fragment {
    ...
    private static TravelFoodFragment mTravelFoodFragment;

    public static TravelFoodFragment newInstance() {
        if (mTravelFoodFragment == null) {
            mTravelFoodFragment = new TravelFoodFragment();
        }
        return mTravelFoodFragment;
    }
