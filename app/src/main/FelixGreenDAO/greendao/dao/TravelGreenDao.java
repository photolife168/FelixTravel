...
*/
public class TravelGreenDao extends AbstractDao<Travel, Long> {
    ...
    */
    ...
    public TravelGreenDao(DaoConfig config) {
        super(config);
    }
    
    public TravelGreenDao(DaoConfig config, DaoSession daoSession) {
